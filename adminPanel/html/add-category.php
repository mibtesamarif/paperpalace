...
?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add Category /</span> Category</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                            <button type="submit" name="addcategory" class="btn btn-primary me-2">Add</button>
                            </div>  
                        </div>
                    </form>
                    <!-- /Account -->
